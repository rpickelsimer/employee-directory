...
<html>
    ...
    <body>
        ...
        <table border="black">
            ...
            <?php
            $result = mysqli_query($con, "SELECT first_name, last_name, phone, address FROM employee WHERE id_employee=" . $wisherID);
            while ($row = mysqli_fetch_array($result)) {
                echo "<tr><td>" . htmlentities($row['first_name']) . "</td>";
                echo "<td>" . htmlentities($row['last_name']) . "</td>";
                echo "<td>" . htmlentities($row['phone']) . "</td>";
                echo "<td>" . htmlentities($row['address']) . "</td></tr>\n";
            }
        ...
        <a href="http://localhost/Employee_Web/employee.php">Perform another search</a>
